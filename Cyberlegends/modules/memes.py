...
*Regex based memes:*
 ...
 ➩ `/decide` can be also used with regex like: `CYBERLEGEND What? <question>: randomly answer "Yes, No" etc.`

  Some other regex filters are:
  `me too` | `good morning` | `good night`.

  𝙾𝙿 𝚁𝙾𝙲𝙺𝚈 𝚁𝙸𝚂𝙷𝙸𝚂𝚄𝙿𝙴𝚁𝚈𝙾 𝙱𝙾𝚃 will reply random strings accordingly when these words are used!
