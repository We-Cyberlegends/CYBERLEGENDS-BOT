...
import Cyberlegends.modules.sql.feds_sql as sql
...
from Cyberlegends.modules.helper_funcs.alternate import (
    send_action,
    send_message,
    typing_action,
)
...
from Cyberlegends.modules.helper_funcs.string_handling import markdown_parser
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "Cyberlegends_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="Cyberlegends_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "Cyberlegends_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="Cyberlegends_fbanned_users.csv",
