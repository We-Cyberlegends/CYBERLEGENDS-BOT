...
import Cyberlegends.modules.sql.welcome_sql as sql
from Cyberlegends import DEV_USERS, LOGGER, MESSAGE_DUMP, OWNER_ID, dispatcher, spamwtc
from Cyberlegends.modules.helper_funcs.alternate import send_message, typing_action
from Cyberlegends.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
from Cyberlegends.modules.helper_funcs.misc import (
    build_keyboard,
    build_keyboard_parser,
    revert_buttons,
)
from Cyberlegends.modules.helper_funcs.msg_types import get_welcome_type
from Cyberlegends.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
    markdown_to_html,
)
from Cyberlegends.modules.log_channel import loggable
from Cyberlegends.modules.sql.global_bans_sql import is_user_gbanned
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                context.bot.send_message(
                    MESSAGE_DUMP,
                    "Cyberlegends have been added to <pre>{}</pre> with ID: \n<pre>{}</pre>".format(
                        chat.title,
                        chat.id),
                    parse_mode=ParseMode.HTML,
                )
