...
from Cyberlegends.modules.sql import warns_sql as warnssql
import Cyberlegends.modules.sql.blacklist_sql as blacklistsql

from Cyberlegends.modules.sql import cust_filters_sql as filtersql
import Cyberlegends.modules.sql.welcome_sql as welcsql
import Cyberlegends.modules.sql.locks_sql as locksql
import Cyberlegends.modules.sql.notes_sql as sql

from Cyberlegends.modules.rules import get_rules
import Cyberlegends.modules.sql.rules_sql as rulessql
from Cyberlegends import DEV_USERS, LOGGER, MESSAGE_DUMP, OWNER_ID, dispatcher
from Cyberlegends.__main__ import DATA_IMPORT
...
from Cyberlegends.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("Cyberlegends-Bot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open(
            "Cyberlegends-Bot{}.backup".format(chat_id),
            "rb"),
        caption="*Successfully backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Cyberlegends-Bot` Backup is specially made for notes.".format(
            chat.title,
            chat_id,
            tgl),
        timeout=360,
    ...
    os.remove("Cyberlegends-Bot{}.backup".format(chat_id))  # Cleaning file
...
*Only for chat administrator:*
 ...
 ➩ /import: Reply to the backup file for the Butler / Cyberlegends group to import as much as possible, making transfers very easy! \
