...
`I'm pero like [@MYOWNER😎⚡](https://t.me/Rishisuperyo)..`
"""
...
buttons += [[InlineKeyboardButton(text="⚡ ADD ME TO YOUR GROUP ⚡",
                                  url="t.me/OP_R0CKY_RISHISUPERYO_TgBot?startgroup=true"),
]]

buttons += [[InlineKeyboardButton(text="⚡⚡OWNER⚡😎",
                                  url="https://t.me/Rishisuperyop"),
...
HELP_STRINGS = f"""
`Hi.. I'm` 𝗖𝗬𝗕𝗘𝗥𝗟𝗘𝗚𝗘𝗡𝗗𝗦[⚡](https://telegra.ph/file/1c554263e1be0ee469fb5.jpg)
...
def start(update, context):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Heya, 𝓔 𝙾𝙿 𝚁𝙾𝙲𝙺𝚈 𝚁𝙸𝚂𝙷𝙸𝚂𝚄𝙿𝙴𝚁𝚈𝙾 𝙱𝙾𝚃 Here, How can I help you? 🧐")
...
if __name__ == "__main__":
    LOGGER.info("ME IZ ONLINE,Successfully loaded modules: " + str(ALL_MODULES))
